function [data_x_wenoX] = der_WENO_minusvx(data, dx)
...
if 0
    ...
    for i=1:(length(data)-6)
        ...
        data_x_1 = v1X/3 - 7*v2X/6 + 11*v3X/6;
        data_x_2 = -v2X/6 + 5*v3X/6 + v4X/3;
        data_x_3 = v3X/3 + 5*v4X/6 - v5X/6;

        epsilon = 1e-6*max([v1X v2X v3X v4X v5X].^2) ...
            + 1e-99;
