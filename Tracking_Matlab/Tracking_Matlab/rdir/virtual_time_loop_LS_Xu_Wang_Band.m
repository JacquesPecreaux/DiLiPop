function [Cxm,Cym,su,old_su]=...
            virtual_time_loop_LS_Xu_Wang_Band(lambdaInside,area_diff_stop,max_iter,small_step_limit,display_every_n,energy_every_n,...
...
%         continuous_heaviside=1/2*(1+2/pi*atan(Level_set_fct/param.epsilon));
        continuous_heaviside=(1/pi)./(1+(Level_set_fct/param.(param_set).epsilon).^2);
