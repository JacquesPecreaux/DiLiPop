function [CEImage] = run_clahe(Image,XRes,YRes,Min,Max,NrX,NrY,NrBins,Cliplimit)
...
LUT=makeLUT_clahe(Min,Max,NrBins);
...
Hist = makeHistogram_clahe(Bin,XSize,YSize,NrX,NrY,NrBins);
if Cliplimit > 0
    Hist = clipHistogram_clahe(Hist,NrBins,ClipLimit,NrX,NrY);
end
Map=mapHistogram_clahe(Hist,Min,Max,NrBins,NrPixels,NrX,NrY);
...
for i = 1:NrX+1
    ...
    for j = 1:NrY+1
        ...
        subImage = interpolate_clahe(subImage,UL,UR,BL,BR,subX,subY);
