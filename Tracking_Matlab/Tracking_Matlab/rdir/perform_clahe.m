function [ CEImage ] = perform_clahe( Image,param_set )
...
%    Cliplimit - Normalized cliplimit (higher values give more contrast)
    ...
    Min = 0;
    Max = 255;
    NrX = param.(param_set).clahe_nb_regions_X;  % 12
    NrY = param.(param_set).clahe_nb_regions_Y;  %12
    NrBins = 256;
    Cliplimit = param.(param_set).clahe_cliplimit; %default = 1.5
