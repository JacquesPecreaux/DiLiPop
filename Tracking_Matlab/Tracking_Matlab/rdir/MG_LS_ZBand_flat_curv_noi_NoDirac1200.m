...
result3 = result1+result2+c3.^2.*lambdaContour.*DiracDeltaApprox(LevelSetFct,epsilon)+(-2).* ...
  ...
  Imagee.^2.*lambdaContour.*DiracDeltaApprox(LevelSetFct,epsilon)+( ...
  -1).*c2.^2.*lambdaOutside.*DiracDeltaApprox(LevelSetFct,epsilon)+ ...
  2.*c2.*Imagee.*lambdaOutside.*DiracDeltaApprox(LevelSetFct, ...
  epsilon)+(-1).*Imagee.^2.*lambdaOutside.*DiracDeltaApprox( ...
  LevelSetFct,epsilon)+(-1).*BandWidth.*lambdaInside.*(Der(:,:,3).^2+ ...
